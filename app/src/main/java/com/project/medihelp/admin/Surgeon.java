...
//                String k_picurl = imageUri.toString();
                ...
                if(TextUtils.isEmpty(Name)){
                    ...
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(Surgeon.this);
...
//                    builder1.setCancelable(true);
                            ...
                            .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                                    if (progressAlertDialog == null) {
                                        AlertDialog.Builder builder2 = new AlertDialog.Builder(Surgeon.this);
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    uploder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            DatabaseReference root = rootNode.getReference("Surgeon");
                                            ...
                                            Toast.makeText(Surgeon.this, "Data Inserted Successfully", Toast.LENGTH_SHORT).show();
                                        }
                                    });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode ==1 && resultCode == RESULT_OK ){
            ...
            try {
                InputStream inputStream  = Surgeon.this.getContentResolver().openInputStream(imageUri);
