...
public class CardiologistAdapter extends FirebaseRecyclerAdapter<userHelper, CardiologistAdapter.myviewholder>{





    public CardiologistAdapter(@NonNull FirebaseRecyclerOptions<userHelper> options) {
        super(options);
    }


    @Override
    protected void onBindViewHolder(@NonNull CardiologistAdapter.myviewholder holder, int position, @NonNull userHelper model) {
        ...
        holder.Delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes",(dialog, i) -> {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Cardiologist")
...
//                                    Log.e(NeurologistMyAdapter, "Error deleting data", databaseError.toException());
        ...
        holder.viewLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("specialistArea", model.getDesignation());
    ...
    @NonNull
    @Override
    public CardiologistAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent,false);
        return new CardiologistAdapter.myviewholder(view);
    }
