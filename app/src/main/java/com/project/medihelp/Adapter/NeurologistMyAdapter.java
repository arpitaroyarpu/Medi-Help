...
public class NeurologistMyAdapter extends FirebaseRecyclerAdapter<modelAdapter, NeurologistMyAdapter.myviewholder>{





    public NeurologistMyAdapter(@NonNull FirebaseRecyclerOptions<modelAdapter> options) {
        super(options);
    }
        ...
        holder.Delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes",(dialog, i) -> {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Neurologis")
